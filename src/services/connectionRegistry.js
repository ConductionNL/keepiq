 ...
 * 2.41.1 ships neither formatter, so Keepiq carries this copy until a release
 * with the built-ins is pinned. The names are the contract's, so the copies
 * across the fleet stay interchangeable.
 *
