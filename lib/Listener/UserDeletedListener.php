...
/**
 * Doriath UserDeletedListener
 *
 * Runs the account-deletion cascade when a Nextcloud user account is deleted,
 * so Doriath data can never outlive its account (secret-export-gdpr D4). The
...
/**
 * Cascades Doriath data deletion on Nextcloud user deletion.
 *
