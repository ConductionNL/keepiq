 ...
 *
 * Database entity representing a secret type.
 *
 * @category Db
...
/**
 * Entity representing a secret type with scope and ownership.
 *
...
class SecretType extends Entity implements JsonSerializable
{
    ...
    /**
     * The Nextcloud user ID for user scope.
     *
     * @var string|null
     */
    ...
    /**
     * When the secret type was created.
     *
     * @var DateTime|null
     */
