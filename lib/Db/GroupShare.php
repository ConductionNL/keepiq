 ...
 *
 * Database entity representing a secret shared with a Nextcloud group.
 * Tracks the secret-group relationship; the individual recipient shares
 * are stored as SecretShare records with group_share_id set.
 *
 * @category Db
...
/**
 * Entity representing a GroupShare.
 *
...
class GroupShare extends Entity implements JsonSerializable
{
    ...
    /**
     * The Nextcloud user ID of the owner who created the share.
     *
     * @var string
     */
