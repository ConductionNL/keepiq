 ...
 *
 * Database entity representing a user-level share of a secret.
 *
 * @category Db
...
/**
 * Entity representing a direct user share of a secret.
 *
...
class SecretShare extends Entity implements JsonSerializable
{
    ...
    /**
     * The ID of the source secret being shared.
     *
     * @var string
     */
    ...
    /**
     * The Nextcloud user ID of the share recipient.
     *
     * @var string
     */
    ...
    /**
     * The ID of the per-user secret copy created for the recipient.
     *
     * @var string
     */
    ...
    /**
     * The group share that originated this user share, if any.
     *
     * @var string|null
     */
