 ...
 *
 * Database mapper for GroupShare entities.
 *
 * @category Db
...
class GroupShareMapper extends QBMapper
{
    ...
    /**
     * Find a single group share for a secret and group, or null.
     *
     * @param string $secretId The secret ID
     * @param string $groupId  The group ID
     *
     ...
     * @param string $secretId The secret ID
     *
     * @return GroupShare[] The deleted group shares
     */
