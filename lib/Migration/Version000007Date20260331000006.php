 ...
 *
 * Create the doriath_sec_shares table.
 *
 * @category Migration
...
{
    /**
     * Create the schema for secret shares.
     *
    ...
    public function changeSchema(IOutput $output, Closure $schemaClosure, array $options): ?ISchemaWrapper
    {
        ...
        if ($schema->hasTable('doriath_sec_shares') === true) {
            return null;
        }

        $table = $schema->createTable('doriath_sec_shares');
