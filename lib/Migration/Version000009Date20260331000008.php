 ...
 *
 * Create the doriath_secret_delegations table for ownership delegation.
 *
 * @category Migration
...
{
    /**
     * Change the database schema to add the secret delegations table.
     *
    ...
    public function changeSchema(IOutput $output, Closure $schemaClosure, array $options): ?ISchemaWrapper
    {
        ...
        $table->addIndex(['original_owner_id'], 'doriath_sd_owner_idx');
