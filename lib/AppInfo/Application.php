...
class Application extends App implements IBootstrap
{
    ...
    public function register(IRegistrationContext $context): void
    {
        ...
        // Group membership change listeners drive group-share new-member
        // approval notifications and auto-revocation on member leave.
        $context->registerEventListener(
        ...
        // EncryptionSuite revocation cascades to the owner's shares and makes
        // their temporary delegations permanent.
        $context->registerEventListener(
            event: EncryptionSuiteRevokedEvent::class,
            listener: EncryptionSuiteRevokedListener::class
        );

        // Compromise migration flags shared copies; notify the original owner.
        $context->registerEventListener(
            event: SharedCopyCompromisedEvent::class,
