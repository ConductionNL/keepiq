...
final class AuditEventTypes
{
     ...
     *
     * Declared as a constant rather than a static accessor so consumers read
     * it as data (AuditEventTypes::METADATA_WHITELIST[$type]) instead of
     * taking a static call dependency on this class.
     *
     * @var array<string,string[]>
     */
    public const METADATA_WHITELIST = [
    ...
    {
        return array_key_exists($eventType, self::METADATA_WHITELIST);
    }//end isKnown()
}//end class
